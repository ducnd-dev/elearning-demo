        ...
        <div className="footer-col footer-card">
          <div className="card-info">
            <div className="card-info-header">
              ...
              <div className="avt">
                {' '}
                <img src="https://khanhhung.academy/template/assets/images/footer/ft-hl-ava.png" alt="" loading="lazy" />
              </div>
            </div>
        ...
        <div className="footer-col footer-follow">
          <div className="card-follow">
            ...
            <div className="card-follow-list">
              <a className="card-follow-item" href="https://www.facebook.com/khanhhung.academy" target="_blank" rel="noreferrer">
                <span className="icon">
                ...
                <div className="hd-menu-info-f d-flex f-start f-nowrap">
                  ...
                  <div className="d-flex a-start">
                    ...
                    <span className="fw-600 hl-purple">
                      <a href="mailto:info@khanhhung.academy" className="link-h">info@khanhhung.academy</a>
                    </span>
                  </div>
                </div>
                <div className="hd-menu-info-f d-flex f-start f-nowrap">
                  ...
                  <div className="d-flex a-start">
                    ...
                    <span className="fw-600 hl-purple">
                      1073/23 Cách Mạng Tháng 8, P.7, Q.Tân
                      Bình, TP.HCM
                    </span>
                  </div>
                </div>
              ...
              <div className="ft-license-wrap">
                ...
                <ul className="social-list d-flex">
                  <li className="social-item ">
                    <a href="https://www.facebook.com/thietkewebsitemonamedia" rel="nofollow external noopener noreferrer" target="1" data-wpel-link="external">
                  ...
                  <li className="social-item ">
                    <a href="https://www.youtube.com/@MONA-Media" rel="nofollow external noopener noreferrer" target="1" data-wpel-link="external">
