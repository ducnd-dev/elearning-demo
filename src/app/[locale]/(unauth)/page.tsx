  ...
  return (
    <div className="grid gap-10 lg:grid-cols-10">
      ...
      <div className="col-span-4 text-center ">
        ...
        <div className="mt-5 overflow-hidden rounded-t-lg bg-white ">
          <div className="flex items-start gap-3 bg-[#12b76a] p-[10px] text-left text-white">
            <img src="https://khanhhung.academy//template/assets/images/home/banner-form-image.png" alt="Khanh Hung" width={20} height={20} />
